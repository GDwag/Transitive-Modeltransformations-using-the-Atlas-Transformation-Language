 ...
 * @generated
 */
public class CirclePackageImpl extends EPackageImpl implements CirclePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private CirclePackageImpl() {
		super(eNS_URI, CircleFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link CirclePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CirclePackage init() {
		if (isInited) return (CirclePackage)EPackage.Registry.INSTANCE.getEPackage(CirclePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCirclePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CirclePackageImpl theCirclePackage = registeredCirclePackage instanceof CirclePackageImpl ? (CirclePackageImpl)registeredCirclePackage : new CirclePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theCirclePackage.createPackageContents();

		// Initialize created meta-data
		theCirclePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCirclePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CirclePackage.eNS_URI, theCirclePackage);
		return theCirclePackage;
	}
	 ...
	 */
	@Override
	public EReference getArchitecture_Circles() {
	 ...
	 */
	@Override
	public EAttribute getCircle_Color() {
	 ...
	 */
	@Override
	public EAttribute getCircle_Rayon() {
	...
	public CircleFactory getCircleFactory() {
		return (CircleFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(architectureEClass, ARCHITECTURE__CIRCLES);
		...
		createEAttribute(circleEClass, CIRCLE__COLOR);
		createEAttribute(circleEClass, CIRCLE__RAYON);
	...
	public void initializePackageContents() {
		...
		initEReference(getArchitecture_Circles(), this.getCircle(), null, "circles", null, 0, -1, Architecture.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCircle_Color(), ecorePackage.getEString(), "color", null, 0, 1, Circle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCircle_Rayon(), ecorePackage.getEInt(), "rayon", null, 0, 1, Circle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRelation_Source(), this.getCircle(), null, "source", null, 1, 1, Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelation_Target(), this.getCircle(), null, "target", null, 1, 1, Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
