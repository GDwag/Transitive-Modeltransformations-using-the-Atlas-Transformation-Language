...
public class ArchitectureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SquarePackage.Literals.ARCHITECTURE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SquarePackage.Literals.ARCHITECTURE__SQUARES);
			childrenFeatures.add(SquarePackage.Literals.ARCHITECTURE__RELATIONS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(SquarePackage.Literals.ARCHITECTURE__SQUARES,
				 SquareFactory.eINSTANCE.createSquare()));

		newChildDescriptors.add
			(createChildParameter
				(SquarePackage.Literals.ARCHITECTURE__RELATIONS,
				 SquareFactory.eINSTANCE.createRelation()));
	}
